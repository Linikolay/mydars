                ...
                if (data1.profile.is_user == false) {
                    ...
                    fetch('https://api.mydars.uz/api/get_lessons/', {
                        ...
                        .then((data) => {
                            ...
                            console.log(data)
                            for (var i = 0; i < data.lessons_in_order.length; i++) {
                                if (data.lessons_in_order[i].teacher_lesson_id == url) {
                                        console.log(data.lessons_in_order[i].lesson_url_teacher)
                                    this.setState({
                                        time: data.lessons_in_order[i].lesson_end_timestamp,
                                        is_user: data1.profile.is_user,
                                        bob: data.lessons_in_order[i].lesson_url_teacher,
                                        isLoaded: true,
                                    })
                                }
                            ...
                            for (var i = 0; i < data.lessons_in_order.length; i++) {
                                ...
                                if (data.lessons_in_order[i].teacher_lesson_id == url) {
                                    ...
                                    this.setState({
                                        is_user: data1.profile.is_user,
                                        isLoaded: true,
                                        bob: data.lessons_in_order[i].lesson_url_student
                                    })
                                }
