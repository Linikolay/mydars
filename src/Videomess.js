...
class Videomess extends Component {
...
this.setState({
    ...
    saveMobile0 = obj => {
        ...
        fetch('https://api.mydars.uz/api/registration/', {
            ...
            .then((data) => {
                    console.log(data)
                this.props.mainPage.changeUnit(7)
    ...
    return(
        <div></div>
                    ...
                    <div className={"top_page_regist"}>
                        ...
                        <img alt="" src={reg_check}/> {this.state.lang.myVideoRolik.text} <img alt="" src={bx_chevron_right}/>
                        <img alt="" src={reg_uncheck}/> {this.state.lang.Vereficationname.text}
                    </div>
                    <div className={"container "}>
                        <div className={"row"}>
                            <div className={" col-lg-12 col-md-4 col-sm-6 col-6 "}>
                                <p className={"tittle_top_page_regst desc_reg_page_09"}>{this.state.lang.VIDEOPRIVETSTVIE.text}</p>
                                <p className={"tittle_top_page_regst2"}>{this.state.lang.CREATEUPLOADMAINFUNC.text}
                               </p>
                                <div className={"first_reg col-lg-12 col-md-4 col-sm-6 col-6 "}>


                                    <div className={"row"}>
                                        <div className={"first_reg col-lg-8 col-md-4 col-sm-6 col-6 "}>
                                            <div className={"container"}>

                                                <p className={"main_sql_change"}>{this.state.lang.UPLOADMAINTEACF.text}</p>
                                                ...
                                                <label htmlFor="filePicker" className={"myst_uploads"}>
                                                    ...
                                                    {this.state.lang.UPLOADVIDEOMAINA.text}
                                                </label>
                                            ...
                                            <p className={"main_sql_change"}> {this.state.lang.HORIZONTMAIN.text}</p>
                                        </div>
                                        <div className={"first_reg col-lg-4 col-md-4 col-sm-6 col-6 "}>
                                            <div className={""}>


                                                <p className={"rigght_polize"}>  {this.state.lang.STUDENTIKISMAIN.text} 
                                               </p>

                                                <p className={"rigght_polize"}>  {this.state.lang.SOvets.text}</p>


                                                <p className={"rigght_polize"}>  {this.state.lang.Zapishmain.text} 
                                               </p>


                                                <p className={"rigght_polize"}> {this.state.lang.ZApisivideitar11.text} 
                                                </p>


                                                <p className={"rigght_polize"}> {this.state.lang.Izbekaimain99.text}
                                               </p>


                                                <p className={"rigght_polize"}>{this.state.lang.BezLogoLOPO.text}
                                                </p>


                                                <p className={"rigght_polize"}> {this.state.lang.POdcherkunit.text}
                                               </p>
                                                <p className={"rigght_polize"}>{this.state.lang.OpishiteLok0999.text} 
                                                </p>
...
if (this.state.imgsert.profile.video.length == 0
