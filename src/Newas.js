        ...
        if (!isLoaded || !langLoad) {
            ...
            return (
                <div>
                        ...
                        <p className={"landtitke"}>   {this.state.lang.registrtxt.text}</p>
                        <div className={" row "}>
                            ...
                            <Link to={"/reg"}>
                                ...
                                <p className={"minilandtitile"}> {this.state.lang.uchiee334.text}</p>
                                    <img alt="" src={this.state.main.welcome_block.block_content[1].icon_url}></img>
                                   
                                    
                              <p><Link to={"/reg"} className={"minilanddesc minilanddesc1 nyyyyy"}>  {this.state.lang.new3y6gfhjrtfh.text}</Link></p>
                            ...
                            <Link to={"/teachercreate"}>
                                ...
                                <p className={"minilandtitile"}> {this.state.lang.teachernntggt55.text}</p>
                                    <img alt="" src={this.state.main.welcome_block.block_content[0].icon_url}></img>
                                   
                                    
                                   <p><Link to={"/teachercreate"} className={"minilanddesc minilanddesc1 nyyyyy"}>  {this.state.lang.startlangue2.text}</Link></p>
                        ...
                        {/* <p className={"landtitke2"}>  Я здесь впервые, хочу <Link to={"/reg"} className={"nyyyyy nyyyyy1"}>зарегистрироваться!</Link></p> */}
                        </div>
